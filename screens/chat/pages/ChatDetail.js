...
import { Button, Pressable, Text, View, StyleSheet, FlatList } from "react-native";
  ...
  return (
    <View style={styles.messagingScreen}>
      <View style={[styles.messagingScreen, { paddingVertical: 15, paddingHorizontal: 10 }]}>
        {chatMessages[0] ? (
          <FlatList
            ...
            renderItem={({ item }) => <Message item={item} userId={loginUser._id} />}
      ...
      <View style={styles.messagingInputContainer}>
        ...
        <Icon type="material" name="send" color={colors.grayBlue} onPress={() => {}} />
      </View>
    </View>
  );
}
